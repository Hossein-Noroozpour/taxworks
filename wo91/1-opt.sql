...
FROM
	...
	,
	(      
		SELECT STL3.CC03_ID, STL3.CC03_CREATE_ON, 'OBJ' FLAG
		FROM 
			STL.TC03_LETTER STL3
			INNER JOIN OBJ.TO02_REQUEST_DETAILS OBJ2
				ON STL3.CC03_ENTITY_ID = OBJ2.CO01_REQUEST_NO
				AND OBJ2.CA02_RETURN_ID = RET2.CA02_RETURN_ID
		WHERE
		...
		UNION  
		SELECT STL3.CC03_ID, STL3.CC03_CREATE_ON, 'AN' FLAG
		FROM STL.TC03_LETTER STL3
		WHERE 
			STL3.CC03_ENTITY_ID = RET2.CA02_RETURN_ID || '-' || RET2.CA02_RETURN_VERSION
